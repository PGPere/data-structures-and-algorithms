...
from linked_list_insertions.linked_list_insertion import LinkedList, TargetError
...
def test_append():
    ...
    assert str(
        linked_list) == "{ banana } -> { apple } -> { cucumber } -> NULL"
...
def test_insert_before():
    ...
    assert str(
        linked_list) == "{ banana } -> { cucumber } -> { apple } -> NULL"
